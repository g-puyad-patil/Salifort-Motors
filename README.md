...
| :--- | :--- | :--- |
| **Accuracy** | `[Your Accuracy %]` | Overall correctness of the model's predictions. |
| **Precision** | `[Your Precision %]` | Out of all predicted departures, how many were actually correct (important for minimizing false alarms). |
| **Recall** | `[Your Recall %]` | Out of all actual departures, how many did the model correctly identify (important for capturing at-risk employees). |
| **F1 Score** | `[Your F1 Score]` | The harmonic mean of Precision and Recall. |
